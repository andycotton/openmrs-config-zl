...
set @educationAnswers = concept_name(@education, @locale);
...
(
  ...
  access_to_transportation varchar(50),
...
update temp_social_econ tsn
set education = concept_name(education_answer_concept, @locale);

update temp_social_econ tsn
set read_and_write = obs_value_coded_list(tsn.encounter_id, 'PIH','13736',@locale);
...
set tsn.travel_time_to_clinic = concept_name(o2.value_coded, @locale);

update temp_social_econ tsn
set access_to_transportation = obs_value_coded_list(tsn.encounter_id, 'PIH','13746',@locale);
...
update temp_social_econ tsn
set currently_employed = obs_value_coded_list(tsn.encounter_id, 'PIH','3395',@locale);
...
and o.voided = 0 and o.concept_id = @recieved_assistance and cn.locale = @locale and concept_name_type = "FULLY_SPECIFIED"
...
and o.voided = 0 and o.concept_id = @recommended_assistance and cn.locale = @locale and concept_name_type = "FULLY_SPECIFIED"
group by encounter_id
) o1 on tsn.encounter_id = o1.encounter_id
